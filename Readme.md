...
- [kind cluster 생성](./kind-cluster/)
- [helm으로 Argo CD설치](./install_argocd_with_helm/)
...
- [example-9: ApplicationSet 개념](./example-9/)
- [example-10: ApplicationSet 여러 예제들](./example-10/)
- [multi-env: ApplicationSet 멀티 환경 관리 (dev 자동/stage·prod 수동 Sync)](./multi-env/)
...
- [argocd preview(diff) with github action](./argocd-diff-preview/)
